...
import { FaVideo, FaComments, FaShieldAlt, FaUsers } from 'react-icons/fa'
        ...
        <section className='py-20 px-4 sm:px-6 pl:px-8'>
            <div className='max-w-7xl mx-auto'>
                <div className='text-center mb-16'>
                    ...
                    <p className='text-xl text-gray-600 max-w-auto'>
                        {APP_CONFIG.HOME_CONTENT.FEATURES.DESCRIPTION}
                    </p>
                </div>

                <div className='grid grid-cols-1 md:grid-cols lg:grid-cols-4 gap-8'>
